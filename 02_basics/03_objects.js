...
const JsUser = {
    ...
    [mySym]: "mykey1", // act the symbol as keys
    age: 23,
    location: "Jamshedpur",
...
console.log(JsUser["email"]) // correct way of calling an object 
console.log(JsUser["full name"]) // cannot be called using . method
...
JsUser.greeting = function(){   // make sure unfreeze the object
